...
资料截至：2026-09-12。本目录提供技术结论、来源版本、文件身份和测量结果。官方游戏归档、第三方程序及完整研发工作目录不在公开资料范围内。
...
下列引用记录了正文采用的历史证据及文件摘要。原始文件未公开，因此读者只能核对公开摘要，不能仅凭 SHA-256 独立验证其内部结论。相应结论在正文中区分历史报告、离线测量和实机结果。
