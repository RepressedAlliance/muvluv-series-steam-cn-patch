...
| --- | --- | --- |
| Muv-Luv photonflowers | **BETA 0.1.1** | [ZIP](https://github.com/imnotsureyi-sys/muvluv-series-steam-cn-patch/releases/download/pf-BETA-0.1.1/MuvLuv_PF_CN_Patch_BETA_0.1.1.zip) · [release](https://github.com/imnotsureyi-sys/muvluv-series-steam-cn-patch/releases/tag/pf-BETA-0.1.1) |
...
PM **BETA 0.1.1** fixes malformed display directives in 297 special-text entries, using the ordinary font to prevent Japanese leakage, duplicate text, and missing glyphs. Install directly over PM BETA 0.1; no uninstall is needed. PF **BETA 0.1.1** adds 11 missing body/annotation glyphs, including those in 首席女伶 and 亟待收复. It also installs directly over PF BETA 0.1.
