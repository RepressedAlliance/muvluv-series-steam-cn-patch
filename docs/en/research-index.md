...
| [Cr6Ti extent](../../rUGP/docs/postmortems/cr6ti.md) | Serialized extent and archive placement padding are different quantities; two legacy records use an explicit profile | Cr6Ti codecs/tests and the 1,490-image manifests | Proven 光子之花 profiles do not imply every rUGP Cr6Ti variant |
