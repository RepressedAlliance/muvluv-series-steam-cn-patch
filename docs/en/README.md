...
| photonflowers and photonmelodies | **BETA 0.1.1** ordinary releases, separate installers; see the [player guide](player-guide.md) | Maintained text, a 1,490-image PF/PM authority and route map, ICI/RIO/CRsa/RUO/Cr6Ti/CRip tools, guarded runtime components, and postmortems |
