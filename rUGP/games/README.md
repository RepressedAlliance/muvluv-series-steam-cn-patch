...
最新中文人工编辑入口已按篇章统一为
[光子之花 13,025 条](photonflowers/translations/README.md) 和
[光子旋律 44,698 条](photonmelodies/translations/README.md)。下面的旧审校及运行时绑定数字
是历史证据层，不是最新章节 CSV 的总数。

| 游戏 | App ID | 已审校文本 | 当前精确绑定 | 图片权威 | 玩家状态 |
| --- | ---: | ---: | ---: | ---: | --- |
| [光子之花](photonflowers/) | 889700 | 12,964 行 | 69 行 | [636 项](photonflowers/images/) | 尚无玩家包 |
| [光子旋律](photonmelodies/) | 889710 | 44,583 行 | 151 行 | [854 项](photonmelodies/images/) | 尚无玩家包 |
