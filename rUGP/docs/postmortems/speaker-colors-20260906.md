...
Status (2026-09-07): opt-in candidate with user-reported 光子之花/光子旋律 live sample pass;
...
covers 134 光子之花 and 221 光子旋律 unique source/Chinese pairs, plus original-alias and
negative regressions: 236 光子之花 / 327 光子旋律 total pairs, zero failures. There are no
...
One explicit input discrepancy is retained: 光子旋律 `.004`, block `655753292`,
...
光子之花/光子旋律 colour samples were all OK. This is sample acceptance, not a claim that
every scene, old-save transition or backlog state was individually verified.

| Game | Installed candidate SHA-256 |
| --- | --- |
| 光子之花 | `4C58F6EC31E73E81222DB25859451B05037B36D0E0BD10A350F6A5B451392158` |
| 光子旋律 | `BD95F8480DD8CEA094E05B0DEBC453EE7F756F77BD71D7DA80072DE88329BBAC` |
...
The current native-message census covers 光子之花 13,163 and 光子旋律 44,848 messages.

The initial experiment added 31 光子之花 and 32 光子旋律 Chinese aliases to the root
`CBoxOcean/CStdb` setting through RUO. A 光子之花 live sample still showed white
...
| --- | --- | --- | --- |
| 光子之花 | `0xB4E80` | `0xB4FEA` | `E8 91 FE FF FF` |
| 光子旋律 | `0xB6B30` | `0xB6C8A` | `E8 A1 FE FF FF` |
...
光子之花 has 53 malformed `姓名【正文】` fields. Restore `【姓名】「正文」`.
光子旋律 has one field whose entire `【武】「…」` wrapper was omitted. The reviewed
...
The 光子旋律 `.004` record uses a fixed-extent edit, not a later-volume RUO redirect.
...
colour restoration in 光子之花 and 光子旋律, old-save/new-scene behavior, backlog colours,
the repaired speaker prefixes, typography and 光子旋律 error regression. The 28
